...
type LiquidationChart = { symbol: string, collectionStartedAt?: string, candles: LiquidationCandle[], events: LiquidationEvent[], status: { exchanges: Record<string, { connected: boolean }> } }
