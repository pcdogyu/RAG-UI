...
import { directionalLevels, ethRiskSymbol, riskRanges, type RiskRange } from './riskRadar'
...
function ETHRiskPage({ theme }: { theme: Theme }) {
...
function App() {
  ...
  const render = () => ({ask:<AskPage />, memory:<MemoryPage />, studio:<StudioPage />, risk:<ETHRiskPage theme={theme} />, liquidationMap:<LiquidationMapPage />, liquidation:<LiquidationBubblePage theme={theme} />, watchlist:<WatchlistPage />, cockpit:<CockpitPage />, sources:<SettingsPage page="sources" />, rules:<SettingsPage page="rules" />, audit:<SettingsPage page="audit" />}[page])
